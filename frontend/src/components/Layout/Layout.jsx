    ...
    <div className="min-vh-100 w-100">
      ...
      <nav className="navbar navbar-light bg-white shadow-sm py-1">
        <div className="container-fluid d-flex align-items-center justify-content-between px-2" style={{minHeight: '60px'}}>
          ...
          {/* Logo centrale */}
          <a className="navbar-brand fw-bold text-danger d-flex align-items-center justify-content-center mx-auto px-2" href="/" style={{fontSize: '1.3rem', flex: 1, textAlign: 'center'}}>
          ...
          <button
            ...
            aria-expanded="false"
            style={{ minWidth: '44px', minHeight: '44px', padding: 0, color: '#dc3545', backgroundColor: 'white' }}
          >
